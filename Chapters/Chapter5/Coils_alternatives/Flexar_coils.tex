...
\begin{samepage}
    ...
    \begin{figure}[H]
        ...
        \resizebox{0.5\textwidth}{!}{
            \input{Chapters/Chapter5/Coils_alternatives/Figures/Flexar_power_profile.tex}
        }
...
\begin{figure}[H]
    \centering
    \resizebox{0.5\textwidth}{!}{ 
        \input{Chapters/Chapter5/Coils_alternatives/Figures/Flexar_magnetic_field_vs_P.tex}
    }
